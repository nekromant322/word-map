...
public interface AdminApi {
    ...
    PagedResponseDto<AdminListQueryDto> getAdmins(
    ...
    void createAdmin(@Valid @RequestBody CreateAdminRequest request);
    ...
    AdminDto getAdmin(@PathVariable Long id);
    ...
    void updateAdmin(@PathVariable Long id, @RequestBody @Valid UpdateAdminRequest request);
    ...
    AdminInfoDto getCurrentAdminInfo();
    ...
    void setLanguage(@PathVariable Long id);
    ...
    void changeAdminAccess(@PathVariable Long id, @RequestBody @Valid ChangeAdminAccessRequest request);
}
